...
explTable = {
    ...
    ["AN_M57"] = { explosive = 56 }, --US, 250 lb 113 kg bomb, 56 kg explosives, general purpose, blast over fragmentation
    ["AN_M64"] = { explosive = 119 }, --US,500 lb 227 kg bomb, 119 kg explosives, general purpose, blast over fragmentation
    ["AN_M65"] = { explosive = 240 }, --US, 1000 lb 454 kg bomb, 240 kg explosives, general purpose, blast over fragmentation
    ...
    --*** WWII ROCKETS ***
    --["V1"] = { explosive = 200, shaped_charge = false },
    ...
    --*** TORPEDO ***
    ["G7A_T1000"] = { explosive = 300 }, --Germany, G7A T1000, 1500 kg torpedo, 300 kg explosives
    ["LTF_5B"] = { explosive = 250 }, --Germany, LT F5b torpedo, 800 kg torpedo, 250 kg explosives
